...
activities = {
    ...
    "Basketball Club": {
        ...
        "max_participants": 15,
        "participants": ["ana@mergington.edu", "paulo@mergington.edu"]
    },
    # Artísticas
    "Drama Club": {
        ...
        "max_participants": 20,
        "participants": ["carla@mergington.edu", "felipe@mergington.edu"]
    },
    "Art Workshop": {
    ...
    "Science Club": {
        ...
        "max_participants": 14,
        "participants": ["renata@mergington.edu", "tiago@mergington.edu"]
    }
}
